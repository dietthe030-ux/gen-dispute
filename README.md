...
- Historical evidence covers the 0% dispute outcome, buyer-confirmed release, and expired recovery. Current-deployment evidence proves exact-ID creation, issuer registration, and finalized 50% partial-mismatch and 100% material-mismatch settlements.
